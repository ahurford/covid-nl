...
**Figure 3. Reported new cases used for this analysis: [Department of Health and Community Services Public Advisories](https://www.gov.nl.ca/releases/covid-19-news/) (dots: raw data and solid line: 14-day average) and [Newfoundland and Labrador COVID-19 Pandemic Update Hub](https://geohub-gnl.hub.arcgis.com/search?q=COVID) (open triangles: raw data and dashed line: 14-day average).** The update of this report on March 2 contained an error as "new cases" in the [Newfoundland and Labrador COVID-19 Pandemic Update Hub](https://geohub-gnl.hub.arcgis.com/search?q=COVID) was understood to be since last reporting; if understood as "on the reporting day" then both data sources agree recently. There is some disagreement between the data sources in January, when hundreds of test results completed out-of-province were reported. In the [Department of Health and Community Services Public Advisories](https://www.gov.nl.ca/releases/covid-19-news/) data (manually curated), these cases were assigned to the day they were reported.  

```{r,echo=F}
gNL3
```

**Figure 4. Reported new cases used for this analysis (last 14 days only).** Both the [Department of Health and Community Services Public Advisories](https://www.gov.nl.ca/releases/covid-19-news/) (solid line and dots) and [Newfoundland and Labrador COVID-19 Pandemic Update Hub](https://geohub-gnl.hub.arcgis.com/search?q=COVID) (dashed line and open triangles)  data are shown, but the data are identical.