...
I use the approximation of [Chui and Ndeffo-Mbah (2021)](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1009374) to estimate the number of unreported cases in Newfoundland and Labrador a week ago, and prior. I then compare the estimated total cases (both reported and unreported) with reported cases to determine if the trend in reported cases (increasing, decreasing, or level) is consistent with the trend in total cases.
</div>
