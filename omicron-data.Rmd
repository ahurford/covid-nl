...
popn = popn[-ind2]
test3 = test3[-ind2]
cases2 = cases2[-(ind2-ind)]
cases1 = head(cases1,-1)
...
To assess the impact of the change in PCR testing recommendations for NL, we assumed that the number of tests reported for NL on a given day is the sum of two components:
...
[On January 10, 2022, NL reported 680 cases](https://www.cbc.ca/news/canada/newfoundland-labrador/nl-covid-testing-delays-1.6309316) arising from tests sent out of province December 29 to January 6th. These cases are not considered in this analysis. 

### Correcting for the testing change on January 3

To correct for the change in PCR testing recommendations (beginning January 3), we assume that beginning January 6th the reporting reflects `r a1-a2` fewer tests per case, and that all these test that did not occur would have been positive. We use this correction so that reported cases can be compared before and after January 6. All subsequent calculations use this correction for cases reported after January 6th.

## Reported cases (including correction for January 3 testing change)
...
**Figure 1.** The correction for the January 3 PCR testing change (line) and reported cases (dots). We assume a 3 day lag for test results such that the January 3 testing change first affects the data on January 6.

```{r,echo=F}
g1
```

**Figure 2.** *Data after January 6th is corrected for the January 3rd testing change. 
