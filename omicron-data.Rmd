...
# Break Jan 3
ind = 15
cases1 = c(cases[1:ind], rep(0,L-ind))
cases2 = c(rep(0,ind), cases[(ind+1):L])
popn = rep((317664+91201+76608+36069),L)
#mod = lm(test1 ~ cases1 + cases2 + popn + 0)
...
**Newfoundland and Labrador: Halving time:  `r round(DT.NL[1],1)` days** 

**Eastern Health: Halving time:  `r round(DT.eastern[1],1)` days** 
