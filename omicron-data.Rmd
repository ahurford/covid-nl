...
This statistical model has poor fit and there are better sources of data than the [Public Service Annoucements](https://www.gov.nl.ca/releases/covid-19-news/). Because the adjustment for changes to PCR testing are important, future updates will include a more thorough analysis of the testing data including visualization of the fit.
