...
NLh = .15*ONh
NLm = .1*ONm
UK.rate = (data$EH+data$LG+data$CH+data$WH)/UKh - c(rep(0,d),head((data$EH+data$LG+data$CH+data$WH)/UKh,-d))
ON.rate = (data$EH+data$LG+data$CH+data$WH)/ONh - c(rep(0,d),head((data$EH+data$LG+data$CH+data$WH)/ONh,-d))
NL.rate = (data$EH+data$LG+data$CH+data$WH)/NLh - c(rep(0,d),head((data$EH+data$LG+data$CH+data$WH)/NLh,-d))
