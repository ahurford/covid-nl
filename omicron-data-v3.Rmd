...
For Newfoundland and Labrador, I estimate $R$ = **`r round(R,1)` secondary infections per infected person** when considering data from the last `r T` days. The doubling time is `r round(dtime,0)` days. For methodological details, see [Methods](#Methods).
